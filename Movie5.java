...
public class Movie5 {
    ...
    public Movie5() throws ClassNotFoundException, SQLException {
        ...
        m1 = new ImageIcon("New Folder/hobbit.jpg");
        b1 = new JButton(m1);
        b1.setBounds(100, 120, 200, 200);
        b1.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
               Search a12=new Search("Hobbit");
            }
        });
        f.add(b1);

        ll1 = new JLabel("Hobbit");
        ll1.setBounds(180, 280, 150, 100);
        f.add(ll1);
